...
def main():
    ...
    logged_data=ms.exec_motions_multimove(breakpoints1,primitives1,primitives2,p_bp1,p_bp2,q_bp1,q_bp2,v1_all,v2_all,z,z)
    ...
    curve_exe=curve_exe1
    curve_exe_R=curve_exe_R1
    curve_exe_js=curve_exe_js1
    #############################chop extension off##################################
    ...
    ax1.plot(lam1[1:],s1_cmd,'p-',label='TCP1 cmd Speed')
