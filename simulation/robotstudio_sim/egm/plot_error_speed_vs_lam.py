...
for s in speed:
    ###read in curve_exe
    data = read_csv(dataset+"curve_exe"+"_"+s+".csv").values
    timestamp=data[:,0]/1000.
    curve_exe_js=data[:,1:]
    lam, curve_exe, curve_exe_R, act_speed=logged_data_analysis(robot,timestamp,curve_exe_js)
