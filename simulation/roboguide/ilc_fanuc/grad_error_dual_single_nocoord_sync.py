...
def main():
    ...
    for i in range(start_iteration,iteration):
        ...
        while True:
            ...
            logged_data=ms.exec_motions_multimove_nocoord(robot1,robot2,primitives1,primitives2,p_bp1_update,p_bp2,q_bp1_update,q_bp2,s,s,z,z)
        ...
        for j in range(step_start+1, step_end): # exclude first and the last bp and the bp for extension
