...
def main():
	...
	###########################################diff evo opt############################################
	lower_limit=np.hstack((robot2.lower_limit,[0,0,0],[-2*np.pi,-2*np.pi,-2*np.pi],[-np.pi]))
	upper_limit=np.hstack((robot2.upper_limit,[3000,3000,3000],[2*np.pi,2*np.pi,2*np.pi],[np.pi]))
