...
recorded_dir='recorded_data/iteration_3/'
...
for i in range(N):
	...
	###throw bad curves
	lam, curve_exe, curve_exe_R,curve_exe_js, speed, timestamp_temp=ms.chop_extension(curve_exe, curve_exe_R,curve_exe_js, speed, timestamp,curve[0,:3],curve[-1,:3])
