...
def main():
    ...
    curve_q1=data['q1'].tolist()[:test_length]
    curve_q2=data['q2'].tolist()[:test_length]
    curve_q3=data['q3'].tolist()[:test_length]
    curve_q4=data['q4'].tolist()[:test_length]
    curve_q5=data['q5'].tolist()[:test_length]
    curve_q6=data['q6'].tolist()[:test_length]
