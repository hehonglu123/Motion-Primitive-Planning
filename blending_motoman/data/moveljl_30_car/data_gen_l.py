...
curve_js[start_idx:end_idx+1]=np.linspace(curve_js[start_idx-1],curve_js[end_idx+1],num=end_idx-start_idx+3)[1:-1]
###update curve in xyz
...
primitives=['movej_fit']+['movel_fit']*l_num_seg+['movej_fit']+['movel_fit']*l_num_seg
points=[[q_init]]
...
points.append([curve_js[end_idx]])
