...
pose_all=robot2_new.fwd(curve_js2)

p_all_new=copy.deepcopy(pose_all.p_all)
p_all_new[:,-1]+=height_offset

curve_js2_new=car2js(robot2_new,curve_js2[0],p_all_new,pose_all.R_all)

np.savetxt('arm2.csv',curve_js2_new,delimiter=',')

_,_,_,_,relative_path,relative_path_R=form_relative_path(curve_js1,curve_js2_new,robot1,robot2_new)
