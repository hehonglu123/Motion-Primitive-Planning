...
def main():
	...
	# train_data = read_csv(data_dir+'Curve_js.csv', names=col_names)
	# # train_data = read_csv('../greedy_fitting/curve_fit_js.csv',names=col_names)
	# curve_q1=train_data['q1'].tolist()
	# curve_q2=train_data['q2'].tolist()
	# curve_q3=train_data['q3'].tolist()
	# curve_q4=train_data['q4'].tolist()
	# curve_q5=train_data['q5'].tolist()
	# curve_q6=train_data['q6'].tolist()
