...
def main():
	...
	for i in range(iteration):
		...
		alpha=0.5
		error1=curve_js1_d[int(extension_start/2):-int(extension_end/2)]-curve_exe_js1[int(extension_start/2):-int(extension_end/2)]
		error2=curve_js2_d[int(extension_start/2):-int(extension_end/2)]-curve_exe_js2[int(extension_start/2):-int(extension_end/2)]

		curve_cmd_js1_ext[int(extension_start/2):-int(extension_end/2)]=curve_cmd_js1_ext[int(extension_start/2):-int(extension_end/2)]+alpha*error1
		curve_cmd_js2_ext[int(extension_start/2):-int(extension_end/2)]=curve_cmd_js2_ext[int(extension_start/2):-int(extension_end/2)]+alpha*error2
